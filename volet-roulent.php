...
$qry = mysqli_query($conn, "SELECT * FROM produits WHERE categorie = 'volet-roulent' ");
...
<body>
  <div id="fh5co-page">
    ...
    <div id="main-content" class="container " class="row animate-box" data-animate-effect="fadeInLeft" class="fh5co-narrow-content">
      <h2 id="categories-title" class="text-center texttop">VOLET ROULENT</h2>
      <br>
      <div class="row mb-5">
        <div class="col-md-12  ">
          <div class="row mb-5">
