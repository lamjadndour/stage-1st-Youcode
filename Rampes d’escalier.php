...
$qry = mysqli_query($conn, "SELECT * FROM produits WHERE categorie = 'Rampes d’escalier' ");
...
<body>
  <div id="fh5co-page">
    ...
    <div id="main-content" class="container " class="row animate-box" data-animate-effect="fadeInLeft" class="fh5co-narrow-content">
      <h2 id="categories-title" class="texttop text-center">Rampes d’escalier</h2>
      <br>
      <div class="row mb-5">
        <div class="col-md-12  ">
          <div class="row mb-5">
              ...
              echo '<div class="col-md-3 col-sm-6 col-xs-12 col-xxs-12">
                          <div class="block-4 text-center border">
                            <figure class="block-3-image">
                              <a href="product-page.php?id=' . $id . '"><img width="250px" height="250px" src="images/' . $img . '" alt="image du ' . $name . '"></a>
                            </figure>
            ...
            <!-- <div class="col-md-3 col-sm-6 col-xs-12 col-xxs-12">
              <div class="block-4 text-center border">
                <figure class="block-3-image">
                  <a href="single-page.html"><img width="250px" height="250px" src="images/ACCESSOIRE DECORATIVE FL .jpg" alt="Image placeholder"></a>
                </figure>
                <div class="block-4-text p-4">
                  <p class="mb-0">ACCESSOIRE DECORATIVE</p>
                </div>
              </div>
            </div> -->
